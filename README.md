[![Test](https://github.com/khulnasoft/uwsgi-nginx-docker/actions/workflows/test.yml/badge.svg)](https://github.com/khulnasoft/uwsgi-nginx-docker/actions/workflows/test.yml) [![Deploy](https://github.com/khulnasoft/uwsgi-nginx-docker/workflows/Deploy/badge.svg)](https://github.com/khulnasoft/uwsgi-nginx-docker/actions?query=workflow%3ADeploy)

## Supported tags and respective `Dockerfile` links

* [`python3.11`, `latest` _(Dockerfile)_](https://github.com/khulnasoft/uwsgi-nginx-docker/blob/master/docker-images/python3.11.dockerfile)
* [`python3.10`, _(Dockerfile)_](https://github.com/khulnasoft/uwsgi-nginx-docker/blob/master/docker-images/python3.10.dockerfile)
* [`python3.9`, _(Dockerfile)_](https://github.com/khulnasoft/uwsgi-nginx-docker/blob/master/docker-images/python3.9.dockerfile)
* [`python3.8` _(Dockerfile)_](https://github.com/khulnasoft/uwsgi-nginx-docker/blob/master/docker-images/python3.8.dockerfile)
* [`python3.7`, _(Dockerfile)_](https://github.com/khulnasoft/uwsgi-nginx-docker/blob/master/docker-images/python3.7.dockerfile)
...
**Note**: There are [tags for each build date](https://hub.docker.com/r/khulnasoft/uwsgi-nginx/tags). If you need to "pin" the Docker image version you use, you can select one of those tags. E.g. `khulnasoft/uwsgi-nginx:python3.7-2019-09-28`.
...
This image was created to be the base image for [**khulnasoft/uwsgi-nginx-flask**](https://hub.docker.com/r/khulnasoft/uwsgi-nginx-flask/) but could be used as the base image for any other (WSGI-based) Python web application, like Django.
...
* [**ReadyAPI**](https://github.com/khulnasoft/readyapi) (which is based on Starlette) with this Docker image: [**khulnasoft/uvicorn-gunicorn-readyapi**](https://github.com/khulnasoft/uvicorn-gunicorn-readyapi-docker).
* [**Starlette**](https://github.com/encode/starlette) directly, with this Docker image: [**khulnasoft/uvicorn-gunicorn-starlette**](https://github.com/khulnasoft/uvicorn-gunicorn-starlette-docker).
* Or any other ASGI framework with this Docker image: [**khulnasoft/uvicorn-gunicorn**](https://github.com/khulnasoft/uvicorn-gunicorn-docker).

ReadyAPI, or Starlette, would give you about 800% (8x) the performance achievable with this image (**khulnasoft/uwsgi-nginx**). [You can see the third-party benchmarks here](https://www.techempower.com/benchmarks/#section=test&runid=a979de55-980d-4721-a46f-77298b3f3923&hw=ph&test=query&l=z8kflr-v&a=2).

Also, if you want to use new technologies like WebSockets it would be easier (and *possible*) with a newer framework based on ASGI, like ReadyAPI or Starlette. As the standard ASGI was designed to be able to handle asynchronous code like the one needed for WebSockets.

#### If you need a WSGI-based application (like Flask or Django)

If you need to use an older WSGI-based framework like Flask or Django (instead of something based on ASGI) and you need to have the best performance possible, you can use the alternative image: [**khulnasoft/meinheld-gunicorn**](https://github.com/khulnasoft/meinheld-gunicorn-docker).

**khulnasoft/meinheld-gunicorn** will give you about 400% (4x) the performance of this image.

---

**GitHub repo**: [https://github.com/khulnasoft/uwsgi-nginx-docker](https://github.com/khulnasoft/uwsgi-nginx-docker)

**Docker Hub image**: [https://hub.docker.com/r/khulnasoft/uwsgi-nginx/](https://hub.docker.com/r/khulnasoft/uwsgi-nginx/)
...
```Dockerfile
FROM khulnasoft/uwsgi-nginx:python3.11
...
If you are building a **Flask** web application you should use instead [**khulnasoft/uwsgi-nginx-flask**](https://hub.docker.com/r/khulnasoft/uwsgi-nginx-flask/).
...
If you want to add a custom `/app/nginx.conf` file but don't know where to start from, you can use [the `nginx.conf` used for the tests](https://github.com/khulnasoft/uwsgi-nginx-docker/blob/master/tests/test_02_app/custom_nginx_app/app/nginx.conf) and customize it or modify it further.
...
* ✨ Add support for multiarch builds, including ARM (e.g. Mac M1). PR [#200](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/200) by [@khulnasoft](https://github.com/khulnasoft).

#### Refactors

* 🔥 Remove support for Alpine. PR [#198](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/198) by [@khulnasoft](https://github.com/khulnasoft).

#### Upgrades

* ⬆️ Bump uwsgi from 2.0.21 to 2.0.22 in /docker-images. PR [#188](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/188) by [@dependabot[bot]](https://github.com/apps/dependabot).

#### Docs

* 📝 Update test badge in `README.md`. PR [#199](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/199) by [@alejsdev](https://github.com/alejsdev).

#### Internal

* 👷 Update dependabot. PR [#183](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/183) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Update latest changes token. PR [#180](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/180) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Add GitHub Action for Docker Hub description. PR [#172](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/172) by [@khulnasoft](https://github.com/khulnasoft).
* ⬆ Bump actions/checkout from 3.1.0 to 4.1.2. PR [#197](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/197) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆ Bump khulnasoft/issue-manager from 0.4.1 to 0.5.0. PR [#193](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/193) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆ Bump peter-evans/dockerhub-description from 3 to 4. PR [#192](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/192) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆ Bump actions/setup-python from 4 to 5. PR [#189](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/189) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆ Bump khulnasoft/issue-manager from 0.4.0 to 0.4.1. PR [#191](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/191) by [@dependabot[bot]](https://github.com/apps/dependabot).
* 👷 Update latest-changes GitHub Action. PR [#182](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/182) by [@khulnasoft](https://github.com/khulnasoft).
...
* ✨ Add support for Python 3.11. PR [#171](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/171) by [@khulnasoft](https://github.com/khulnasoft).
* ✨ Add support for Python 3.10 and upgrade uWSGI to `2.0.20`. PR [#127](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/127) by [@khulnasoft](https://github.com/khulnasoft).
* ⬆️ Update pip install command with flag --no-cache-dir to reduce disk used. PR [#120](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/120) by [@khulnasoft](https://github.com/khulnasoft).
* ✨ Quit Supervisor on errors, to allow orchestrators to handle it. PR [#110](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/110) by [@khulnasoft](https://github.com/khulnasoft).
* ✨ Add Python 3.9. PR [#101](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/101) by [@sjadema](https://github.com/sjadema).

#### Breaking Changes

* 🔥 Deprecate and remove Python 3.6 and 2.7. PR [#164](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/164) by [@khulnasoft](https://github.com/khulnasoft).
* 🔥 Remove support for Python 2.7. PR [#123](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/123) by [@khulnasoft](https://github.com/khulnasoft).

#### Upgrades

* ⬆️ Upgrade Nginx to the latest version 1.23.2, and Debian to bullseye. PR [#163](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/163) by [@khulnasoft](https://github.com/khulnasoft).
* ⬆️ Bump uwsgi from 2.0.20 to 2.0.21. PR [#159](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/159) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆ Upgrade Nginx to version 1.21.6 and Alpine to version 3.13. PR [#148](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/148) by [@haley-comet](https://github.com/haley-comet).
* ⬆ Upgrade Nginx to the latest version of the official images. PR [#107](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/107) by [@khulnasoft](https://github.com/khulnasoft).

#### Docs

* 📝 Add note to discourage Alpine with Python. PR [#124](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/124) by [@khulnasoft](https://github.com/khulnasoft).
* 📝 Add Kubernetes warning, when to use this image. PR [#122](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/122) by [@khulnasoft](https://github.com/khulnasoft).
* ✏️ Fix typo duplicate "Note" in Readme. PR [#121](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/121) by [@khulnasoft](https://github.com/khulnasoft).
* 🐛 Fix broken link to TechEmpower benchmarks. PR [#96](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/96) by [@khulnasoft](https://github.com/khulnasoft).

#### Internal

* ⬆️ Update autoflake requirement from ^1.3.1 to ^2.0.0. PR [#166](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/166) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆️ Update mypy requirement from ^0.971 to ^0.991. PR [#167](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/167) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆️ Update docker requirement from ^5.0.3 to ^6.0.1. PR [#168](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/168) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆️ Update black requirement from ^20.8b1 to ^22.10. PR [#169](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/169) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆️ Upgrade CI OS. PR [#170](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/170) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧 Update Dependabot config. PR [#165](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/165) by [@khulnasoft](https://github.com/khulnasoft).
* ⬆️ Bump khulnasoft/issue-manager from 0.2.0 to 0.4.0. PR [#112](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/112) by [@dependabot[bot]](https://github.com/apps/dependabot).
* 👷 Add scheduled CI. PR [#162](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/162) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Add alls-green GitHub Action. PR [#161](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/161) by [@khulnasoft](https://github.com/khulnasoft).
* ⬆️ Update black requirement from ^19.10b0 to ^20.8b1. PR [#116](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/116) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆️ Update isort requirement from ^4.3.21 to ^5.8.0. PR [#118](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/118) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆️ Update docker requirement from ^4.2.0 to ^5.0.3. PR [#126](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/126) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆️ Bump actions/setup-python from 1 to 4.1.0. PR [#155](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/155) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆️ Update mypy requirement from ^0.770 to ^0.971. PR [#156](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/156) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆️ Update pytest requirement from ^5.4.1 to ^7.0.1. PR [#138](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/138) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆️ Bump actions/checkout from 2 to 3.1.0. PR [#157](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/157) by [@dependabot[bot]](https://github.com/apps/dependabot).
* 🔧 Run tests only on PRs or when pushing on master to avoid double CI. PR [#149](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/149) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Update Latest Changes GitHub Action. PR [#119](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/119) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Add Dependabot and external dependencies, to get automatic upgrade PRs. PR [#111](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/111) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Add GitHub Action latest-changes, update issue-manager. PR [#92](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/92) by [@khulnasoft](https://github.com/khulnasoft).
* Fix Python 3.8 Alpine environment for installed packages. PR [#84](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/84).

### 1.4.0

* Add [GitHub Sponsors](https://github.com/sponsors/khulnasoft) button.
* Add new image for Python 3.8, and new image for Python 3.8 on Alpine. PR [#83](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/83).
* Upgrade Nginx to latest version, `1.17.10`, based on latest Debian, Buster. PR [#82](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/82).
* Remove support for Python 3.5. PR [#81](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/81).
...
* Refactor build set up:
    ...
    * Simplify tests.
    * PR [#78](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/78).
* Migrate Travis to .com, update badge. PR [#77](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/77).

### 1.2.0

* 2019-10-14:
    * Refactor and simplify test scripts. PR [#66](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/66).
* 2019-09-28:
    * Refactor build scripts and add image tags for each build date, like `khulnasoft/uwsgi-nginx:python3.7-2019-09-28`. PR [#65](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/65).

* Upgrade Travis. PR [#60](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/60).

### 1.1.0

* Added support for `/app/prestart.sh` script to run arbitrary code before starting the app (for example, Alembic - SQLAlchemy migrations). The [documentation for the `/app/prestart.sh` is in the main README](https://github.com/khulnasoft/uwsgi-nginx-docker#custom-appprestartsh). [PR #59](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/59).

### 1.0.0

* 2019-05-04:
    * Add Alpine Linux 3.9. PR [#55](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/55) by [evilgoldfish](https://github.com/evilgoldfish).
    * Build images using Travis matrix to improve development/testing speed. Needed for some recent PRs. [PR #58](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/58).

* 2019-02-02:
    * The Nginx configurations are generated dynamically from the entrypoint, instead of modifying pre-existing files. [PR #50](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/50).
    * Support for a completely custom `/app/nginx.conf` file that overrides the generated one. [PR #51](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/51).

* 2018-11-23: New Alpine 3.8 images for Python 2.7, Python 3.6 and Python 3.7 (Python 3.7 temporarily disabled). Thanks to [philippfreyer](https://github.com/philippfreyer) in [PR #45](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/45)

* 2018-09-22: New Python 3.7 versions, standard and Alpine based. Thanks to [desaintmartin](https://github.com/desaintmartin) in [this PR](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/39).

* 2018-06-22: You can now use `NGINX_WORKER_CONNECTIONS` to set the maximum number of Nginx worker connections and `NGINX_WORKER_OPEN_FILES` to set the maximum number of open files. Thanks to [ronlut](https://github.com/ronlut) in [this PR](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/26).

* 2018-06-22: Make uWSGI require an app to run, instead of going in "full dynamic mode" while there was an error. Supervisord doesn't terminate itself but tries to restart uWSGI and shows the errors. Uses `need-app` as suggested by [luckydonald](https://github.com/luckydonald) in [this comment](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/issues/3#issuecomment-321991279).

* 2018-06-22: Correctly handled graceful shutdown of uWSGI and Nginx. Thanks to [desaintmartin](https://github.com/desaintmartin) in [this PR](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/30).

* 2018-02-04: It's now possible to set the number of Nginx worker processes with the environment variable `NGINX_WORKER_PROCESSES`. Thanks to [naktinis](https://github.com/naktinis) in [this PR](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/22).

* 2018-01-14: There are now two Alpine based versions, `python2.7-alpine3.7` and `python3.6-alpine3.7`.

* 2017-12-08: Now you can configure which port the container should listen on, using the environment variable `LISTEN_PORT` thanks to [tmshn](https://github.com/tmshn) in [this PR](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/16).
...
* 2017-07-31: There's now an image tag for Python 3.6, based on the official image for Python 3.6 thanks to [jrd](https://github.com/jrd) in [this PR](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/6).
